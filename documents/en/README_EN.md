...
- [Cloudflare Optimization Solutions](https://github.com/vitaminx/v2ray-agent-copy/blob/master/documents/optimize_V2Ray.md)
- [Traffic Transit Tutorial](https://github.com/vitaminx/v2ray-agent-copy/blob/master/documents/traffic_relay.md)
...
- [Cloudflare Introductory tutorial](https://github.com/vitaminx/v2ray-agent-copy/blob/master/documents/cloudflare_init.md)
...
- Support IPv6，[IPv6 Notes](https://github.com/vitaminx/v2ray-agent-copy/blob/master/documents/IPv6_help.md)
...
- [Support custom certificate installation](https://github.com/vitaminx/v2ray-agent-copy/blob/master/documents/install_tls.md)
...
- wget: command not found [**Here you need to manually install the wget yourself**]
  ，If you have not used Linux，[Click to view](https://github.com/vitaminx/v2ray-agent-copy/tree/master/documents/install_tools.md)Installation Tutorial
...
## [Scripting Common Commands](https://github.com/vitaminx/v2ray-agent-copy/blob/master/documents/common_commands.md)

## [Common script errors handling](https://github.com/vitaminx/v2ray-agent-copy/blob/master/documents/shell_error.md)
...
- Latest Version
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/vitaminx/v2ray-agent-copy/master/shell/install_en.sh" && chmod 700 /root/install_en.sh && mv /root/install_en.sh /root/install.sh && /root/install.sh
```
...
[![Stargazers over time](https://starchart.cc/vitaminx/v2ray-agent-copy.svg)](https://starchart.cc/vitaminx/v2ray-agent-copy)
